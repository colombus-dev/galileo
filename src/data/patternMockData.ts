...
export const mockDataPattern: PatternType[] = [
    ...
    },
    {
        ...
        score: { '[0-0.2[': 28, '[0.2-0.4[': 21, '[0.4-0.6[': 0, '[0.6-0.8[': 27, '[0.8-1.0]': 30 },
    ...
    },
    {
        ...
        schema: 'Feature Eng -> Transform -> Save',
        score: { '[0-0.2[': 11, '[0.2-0.4[': 9, '[0.4-0.6[': 18, '[0.6-0.8[': 33, '[0.8-1.0]': 9 },
    ...
    },
    {
        ...
        score: { '[0-0.2[': 25, '[0.2-0.4[': 36, '[0.4-0.6[': 9, '[0.6-0.8[': 26, '[0.8-1.0]': 26 },
    ...
    },
    {
        ...
        score: { '[0-0.2[': 8, '[0.2-0.4[': 21, '[0.4-0.6[': 50, '[0.6-0.8[': 4, '[0.8-1.0]': 21 },
    ...
    },
    {
        ...
        schema: 'Scale -> Fit -> Feature Importance',
        score: { '[0-0.2[': 1, '[0.2-0.4[': 9, '[0.4-0.6[': 3, '[0.6-0.8[': 35, '[0.8-1.0]': 24 },
    ...
    },
    {
        id: 'RF_Bagging_Init',
        schema: 'Feature Eng -> Transform -> Save',
        score: { '[0-0.2[': 16, '[0.2-0.4[': 8, '[0.4-0.6[': 0, '[0.6-0.8[': 4, '[0.8-1.0]': 45 },
    ...
    },
    {
        ...
        schema: 'Images -> CNN -> Classify',
        score: { '[0-0.2[': 23, '[0.2-0.4[': 41, '[0.4-0.6[': 49, '[0.6-0.8[': 21, '[0.8-1.0]': 5 },
    ...
    },
    {
        ...
        score: { '[0-0.2[': 14, '[0.2-0.4[': 24, '[0.4-0.6[': 29, '[0.6-0.8[': 43, '[0.8-1.0]': 21 },
    ...
    },
    {
        ...
        schema: 'Load Data -> Clean -> Output',
        score: { '[0-0.2[': 20, '[0.2-0.4[': 2, '[0.4-0.6[': 30, '[0.6-0.8[': 50, '[0.8-1.0]': 35 },
    ...
    },
    {
        ...
        schema: 'Images -> CNN -> Classify',
        score: { '[0-0.2[': 32, '[0.2-0.4[': 17, '[0.4-0.6[': 20, '[0.6-0.8[': 4, '[0.8-1.0]': 50 },
    ...
    },
    {
        ...
        schema: 'Train/Test Split -> Fit -> Predict',
        score: { '[0-0.2[': 1, '[0.2-0.4[': 10, '[0.4-0.6[': 4, '[0.6-0.8[': 9, '[0.8-1.0]': 3 },
    ...
    },
    {
        ...
        schema: 'Images -> CNN -> Classify',
        score: { '[0-0.2[': 45, '[0.2-0.4[': 19, '[0.4-0.6[': 50, '[0.6-0.8[': 47, '[0.8-1.0]': 2 },
    ...
    },
    {
        ...
        score: { '[0-0.2[': 34, '[0.2-0.4[': 31, '[0.4-0.6[': 1, '[0.6-0.8[': 17, '[0.8-1.0]': 8 },
    ...
    },
    {
        ...
        schema: 'Vectorize -> Cluster -> Elbow',
        score: { '[0-0.2[': 16, '[0.2-0.4[': 18, '[0.4-0.6[': 36, '[0.6-0.8[': 9, '[0.8-1.0]': 31 },
    ...
    },
    {
        ...
        schema: 'Train/Test Split -> Fit -> Predict',
        score: { '[0-0.2[': 45, '[0.2-0.4[': 30, '[0.4-0.6[': 12, '[0.6-0.8[': 42, '[0.8-1.0]': 19 },
    ...
    },
    {
        ...
        schema: 'Feature Eng -> Transform -> Save',
        score: { '[0-0.2[': 44, '[0.2-0.4[': 37, '[0.4-0.6[': 50, '[0.6-0.8[': 19, '[0.8-1.0]': 6 },
    ...
    },
    {
        ...
        schema: 'Load API -> Prompt -> Response',
        score: { '[0-0.2[': 15, '[0.2-0.4[': 44, '[0.4-0.6[': 2, '[0.6-0.8[': 19, '[0.8-1.0]': 15 },
    ...
    },
    {
        ...
        schema: 'Train/Test Split -> Fit -> Predict',
        score: { '[0-0.2[': 33, '[0.2-0.4[': 20, '[0.4-0.6[': 40, '[0.6-0.8[': 14, '[0.8-1.0]': 33 },
    ...
    },
    {
        ...
        schema: 'Load API -> Prompt -> Response',
        score: { '[0-0.2[': 10, '[0.2-0.4[': 14, '[0.4-0.6[': 24, '[0.6-0.8[': 11, '[0.8-1.0]': 34 },
    ...
    },
    {
        ...
        schema: 'Train/Test Split -> Fit -> Predict',
        score: { '[0-0.2[': 49, '[0.2-0.4[': 10, '[0.4-0.6[': 24, '[0.6-0.8[': 23, '[0.8-1.0]': 6 },
    ...
    },
    {
        ...
        schema: 'Feature Eng -> Transform -> Save',
        score: { '[0-0.2[': 29, '[0.2-0.4[': 32, '[0.4-0.6[': 48, '[0.6-0.8[': 40, '[0.8-1.0]': 33 },
    ...
    },
    {
        ...
        schema: 'Scale -> Fit -> Feature Importance',
        score: { '[0-0.2[': 50, '[0.2-0.4[': 2, '[0.4-0.6[': 33, '[0.6-0.8[': 24, '[0.8-1.0]': 18 },
    ...
    },
    {
        ...
        schema: 'Load API -> Prompt -> Response',
        score: { '[0-0.2[': 32, '[0.2-0.4[': 16, '[0.4-0.6[': 27, '[0.6-0.8[': 33, '[0.8-1.0]': 33 },
...

    {
        ...
        schema: 'Scale -> Fit -> Feature Importance',
        score: { '[0-0.2[': 43, '[0.2-0.4[': 24, '[0.4-0.6[': 34, '[0.6-0.8[': 25, '[0.8-1.0]': 13 },
    ...
    },
    {
        ...
        schema: 'Scale -> Fit -> Feature Importance',
        score: { '[0-0.2[': 28, '[0.2-0.4[': 23, '[0.4-0.6[': 20, '[0.6-0.8[': 32, '[0.8-1.0]': 21 },
    ...
    },
    {
        ...
        schema: 'Feature Eng -> Transform -> Save',
        score: { '[0-0.2[': 23, '[0.2-0.4[': 19, '[0.4-0.6[': 46, '[0.6-0.8[': 47, '[0.8-1.0]': 34 },
    ...
    },
    {
        ...
        schema: 'Train/Test Split -> Fit -> Predict',
        score: { '[0-0.2[': 37, '[0.2-0.4[': 16, '[0.4-0.6[': 43, '[0.6-0.8[': 36, '[0.8-1.0]': 50 },
    ...
    },
    {
        ...
        schema: 'Load Data -> Clean -> Output',
        score: { '[0-0.2[': 10, '[0.2-0.4[': 18, '[0.4-0.6[': 48, '[0.6-0.8[': 18, '[0.8-1.0]': 38 },
    ...
    },
    {
        ...
        schema: 'Train/Test Split -> Fit -> Predict',
        score: { '[0-0.2[': 47, '[0.2-0.4[': 47, '[0.4-0.6[': 2, '[0.6-0.8[': 8, '[0.8-1.0]': 18 },
    ...
    },
    {
        ...
        schema: 'Train/Test Split -> Fit -> Predict',
        score: { '[0-0.2[': 13, '[0.2-0.4[': 10, '[0.4-0.6[': 14, '[0.6-0.8[': 9, '[0.8-1.0]': 25 },
    ...
    },
    {
        ...
        schema: 'Load Data -> Clean -> Output',
        score: { '[0-0.2[': 15, '[0.2-0.4[': 49, '[0.4-0.6[': 43, '[0.6-0.8[': 29, '[0.8-1.0]': 47 },
