...
export const mockNotebooks: NotebookData[] = [
  {
    ...
    context: {
      ...
      data: {
        inputLabel: "Entrée",
        inputDetail:
          "Mesures morphologiques (longueur/largeur sépales et pétales) — 150 × 4",
        outputLabel: "Sortie",
        outputDetail:
          "Espèce d'Iris — Multi-classes (3): Setosa, Versicolor, Virginica",
      ...
      checkpoints: [
        {
          ...
          status: "warning",
          detail:
            "Le notebook indique un split sans normalisation (à justifier selon le modèle).",
        },
        {
          id: "cp-stratified-split",
          category: "split",
          ...
          status: "warning",
          detail:
            "Le contexte indique un split manquant (trainTestSplitLabel = —).",
        },
        {
          id: "cp-eval-on-test",
          category: "evaluation",
          ...
          status: "error",
          detail:
            "Le contexte indique une évaluation sur Train : risque de score surestimé.",
        },
      ],
      initialCheckedCheckpointIds: [],
      initialComment: "",
